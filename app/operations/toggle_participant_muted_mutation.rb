class ToggleParticipantMutedMutation < Types::BaseMutation
  description "Mute and unmutes a participant"
  ...
  def resolve
    ...
    result = ToggleMutedForConferenceParticipant.new(participant).call
